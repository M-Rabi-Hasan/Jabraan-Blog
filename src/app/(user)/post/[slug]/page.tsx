...
import { sanityClient, urlFor } from "@/lib/createClient"; // Corrected import
...
export const generateStaticParams = async () => {
  ...
  const slugs: Post[] = await sanityClient.fetch(query); // Corrected client reference
...
const SlugPage = async ({ params: { slug } }: Props) => {
  ...
  const post: Post = await sanityClient.fetch(query, { slug }); // Corrected client reference
  console.log(post)
